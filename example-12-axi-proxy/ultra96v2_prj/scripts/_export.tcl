...
proc create_root_design { parentCell } {
  ...
  # Create instance: AxiProxy_HP, and set properties
  set AxiProxy_HP [ create_bd_cell -type ip -vlnv j-marjanovic.io:user:AxiProxy:0.2 AxiProxy_HP ]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets AxiProxy_HP_MNGR] [get_bd_intf_pins AxiProxy_HP/MNGR] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AxiProxy_ACP/MNGR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIACP/ACP_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AxiProxy_HP/MNGR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces AxiProxy_HPC/MNGR] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xA0040000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs AxiProxy_ACP/CTRL/regs] -force
