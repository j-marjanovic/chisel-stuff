...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net AxiTrafficGen_APC_MNGR [get_bd_intf_pins AxiTrafficGen_ACP/MNGR] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_ACP_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets AxiTrafficGen_APC_MNGR] [get_bd_intf_pins AxiTrafficGen_ACP/MNGR] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  connect_bd_intf_net -intf_net AxiTrafficGen_HPC_MNGR [get_bd_intf_pins AxiTrafficGen_HPC/MNGR] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HPC0_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets AxiTrafficGen_HPC_MNGR] [get_bd_intf_pins AxiTrafficGen_HPC/MNGR] [get_bd_intf_pins system_ila_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net AxiTrafficGen_HP_MNGR [get_bd_intf_pins AxiTrafficGen_HP/MNGR] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP0_FPD]
connect_bd_intf_net -intf_net [get_bd_intf_nets AxiTrafficGen_HP_MNGR] [get_bd_intf_pins AxiTrafficGen_HP/MNGR] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
